...
DEFAULT_CATEGORIES = [
    ...
    {"name": "Brandstof", "color": "#f97316", "icon": "⛽",
     "keywords": "shell,bp,esso,total,texaco,tango,tinq,tamoil,gulf,avia,q8,ok,tankstation,brandstof"},
    {"name": "Auto", "color": "#475569", "icon": "🚗",
     "keywords": "apk,rdw,kwikfit,profile tyrecenter,bovag,autobedrijf,garagebedrijf,anwb,motorrijtuigenbelasting"},
    {"name": "Belasting", "color": "#78716c", "icon": "🏛️",
     "keywords": "belastingdienst aanslag,motorrijtuigenbelasting,wegenbelasting,waterschap,ozb,afvalstoffenheffing,rioolheffing"},
    {"name": "Goede Doelen", "color": "#e11d48", "icon": "❤️",
     "keywords": "greenpeace,wnf,plan nederland,unicef,amnesty,rode kruis,oxfam,kwf,hartstichting,donatie,giro555"},
    {"name": "Kinderen", "color": "#fbbf24", "icon": "👶",
     "keywords": "kinderopvang,kdv,bso,ouderbijdrage,schoolgeld,intertoys,bart smit,lobbes,speelgoed,prenatal"},
    {"name": "Huisdieren", "color": "#16a34a", "icon": "🐾",
     "keywords": "dierenarts,dierenkliniek,pets place,discus,brekz,dierenwinkel,hondenvoer,kattenvoer"},
    {"name": "Persoonlijke Verzorging", "color": "#c026d3", "icon": "💇",
     "keywords": "kapper,kapsalon,barbier,schoonheidssalon,nagelstudio,parfumerie,douglas,ici paris"},
    {"name": "Sparen & Beleggen", "color": "#0e7490", "icon": "📈",
     "keywords": "degiro,bitvavo,coinbase,bux,binck,easybroker,ishares,vanguard,blackrock,meesman,beleggen"},
    {"name": "Geldopname", "color": "#65a30d", "icon": "💵",
     "keywords": "geldautomaat,geldopname,atm,gea"},
